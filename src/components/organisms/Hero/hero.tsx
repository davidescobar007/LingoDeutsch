...
import { OrganismImageCard as MoleculeImageCard } from '../ImageCard/imageCard'
...
export const OrganismHero: FunctionComponent<TOrganismHero> = ({
   image = '',
   title = '',
   text_content = '',
   level = emptyArray,
   ...
   saveVocabulary: _saveVocabulary
}) => {
