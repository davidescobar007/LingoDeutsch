...
const Navbar = ({ locale }: { locale: string }) => {
   ...
   return (
      <header className=" navbar  bg-primary flex h-14 px-4 shadow-md md:px-10 lg:px-20">
         <div className="flex-1">
            ...
            <Link href="/">
               <AtomTitle extraClassName="hidden md:block select-none flex content-center text-white" type="h1">
                  Blablin
               </AtomTitle>
            </Link>
         </div>
